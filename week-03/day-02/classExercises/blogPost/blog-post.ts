...
class Blog {
    ...
    update(index: number, blogPost: BlogPost) {
        ...
        console.log(`Blogpost #${index+1} has been replaced with a new post titled: ${blogPost.title}.`)
    }
}
...
myBlog.delete(2);
myBlog.update(1, new BlogPost('Yasmine', 'Doudou love', 'Me\'s love you\'s', '2020.07.28'));
console.log(myBlog.blogPosts);